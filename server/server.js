(function (global, factory) {
    ...
    className ServiceError extends Error {
    ...
    className NotFoundError extends ServiceError {
    ...
    className RequestError extends ServiceError {
    ...
    className ConflictError extends ServiceError {
    ...
    className AuthorizationError extends ServiceError {
    ...
    className CredentialError extends ServiceError {
